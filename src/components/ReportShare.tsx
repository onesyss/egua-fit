...
export function ReportShare({
  ...
  const message = useMemo(
    () => buildReportMessage(record, note),
    [record, note],
  )
  ...
  return (
    <div className="no-print rounded-2xl border border-brand-100 bg-white p-4 shadow-sm dark:border-slate-800 dark:bg-slate-900/90 sm:p-5">
      <h2 className="font-display text-lg font-bold text-ink">
        Enviar relatório ao aluno
      </h2>
      <p className="mt-1 text-sm text-ink-muted">
        Use o WhatsApp ou o e-mail cadastrado — ou informe outro contato agora.
        O recado abre no Zap/e-mail com o relatório pronto para enviar.
      </p>
